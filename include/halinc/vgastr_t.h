...
#define VGA_ADR	(0xffff800000000000+0xB8000)		//显存地址
#define VGA_END	(0xffff800000000000+0xBffff)		//显存结束地址
#define VGA_ROW	25			    		//默认最大行数25
#define VGA_COL 	80		    			//默认最大列数80
#define OFFSET(r,c) (((c)+(r)*VGA_COL)*2) 	//屏幕(r,c)处字符的偏移地址 
#define VGA_DEFAULT_VAL 0x0f00			//默认字符
