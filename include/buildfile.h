...
//硬件抽象层目标文件
#define BUILD_HALY_OBJS _string.o _stdio.o \
				_hal.o hal.o vgastr.o global.o platform.o \
...
#define BUILD_KRNL_OBJS 	kernel.o knlglobal.o \
					...
					objnode.o thread.o schedule.o waitlist.o idle.o sem.o \
					device.o krlinterrupt.o systime.o \
					syscall.o service.o
//内存管理目标文件
...
//驱动程序目标文件
#define BUILD_DRIV_OBJS 	drvtick.o drvrfs.o drvhhd.o drvkeyboard.o
//进程管理目标文件
#define BUILD_TASK_OBJS 		//all relative *.o
//函数库目标文件
#define BUILD_LIBS_OBJS 	libassert.o libctype.o liberrno.o libfloat.o liblimits.o \
					liblocale.o libmath.o libsetjmp.o libsignal.o libstdarg.o \
					libstddef.o libstdio.o libstdlib.o libstring.o libtime.o \
					libitime.o
